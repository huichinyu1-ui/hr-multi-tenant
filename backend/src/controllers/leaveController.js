    ...
    if (activeTab === 'requests') {
      ...
      for (const q of quotas) {
        ...
        sheet.addRow({
          ...
          total: parseFloat((q.total_hours / 8).toFixed(3)),
          used: parseFloat((usedHours / 8).toFixed(3)),
          remaining: parseFloat((((q.carried_over_hours||0) + (q.annual_hours||0)) - usedHours) / 8).toFixed(3),
